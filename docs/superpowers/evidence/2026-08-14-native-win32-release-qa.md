...
- The packaged EXE was built from native implementation commit `69f95ce059cec1a7342c839b88d35720a1174c35`; this evidence record does not alter native sources. Rebuild the release EXE from that native implementation immediately before upload.
